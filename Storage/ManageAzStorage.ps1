...
function ManageAzStorage {
    Begin {
        :ManageAzureStorage while ($true) { # :ManageAzureStorage named loop to select search function
            ...
            Write-Host "2 Manage Key Vaults" # Write message to screen
            ...
            elseif ($ManageAzStorage -eq '2') { # Elseif statement for managing keyvaults
            ...
            elseif ($ManageAzStorage -eq '5') { # Elseif statement for managing disks
