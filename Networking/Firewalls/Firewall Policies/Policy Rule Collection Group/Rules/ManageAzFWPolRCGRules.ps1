...
<# Functions Description: {
    ManageAzFWPolRCGRules:      Function to manage firewall policy rule collection group rules
    NewAzFWPolRCGRule:          Function to create a new firewall policy rule collection group rule
    ListAzFWPolRCGRule:         Function to list all firewall policy rule collection group rules
    RemoveAzFWPolRCGRule:       Function to remove a firewall policy rule collection group rule
    SetAzFWPolRCGRulePri:       Function to set a firewall policy rule collection group rule priority
    GetAzFWPolRCGRule:          Function to get firewall policy rule collection group rule    
} #>
<# Variables: {      
...
<# Process Flow {
    function
        Call ManageAzFWPolRCGRules > Get $null
            
        
        End ManageAzFWPolRCGRules
            Return function > Send $null
}#>
function ManageAzFWPolRCGRules {                                                            # Function to manage firewall policy rule collection group rules
    Begin {                                                                                 # Begin function
        :ManageAzureFWPolicyRCG while ($true) {                                             # Outer loop for managing function
            Write-Host 'Manage Firewall Policy Rule Collection Group Rules'                 # Write message to screen
            Write-Host ''                                                                   # Write message to screen
            Write-Host '[0] Exit'                                                           # Write message to screen
            Write-Host '[1] New Firewall Policy RCG Rule'                                   # Write message to screen
            Write-Host '[2] List Firewall Policies RCG Rules'                               # Write message to screen
            Write-Host '[3] Remove Firewall Policy RCG Rule'                                # Write message to screen
            Write-Host '[4] Update Firewall Policy RCG Rule priority'                       # Write message to screen
            Write-Host ''                                                                   # Write message to screen
...
}                                                                                           # End function ManageAzFWPolRCGRules
function NewAzFWPolRCGRule {                                                                 # Function to create a new firewall policy rule collection group
    Begin {                                                                                 # Begin function
        if (!$CallingFunction) {                                                            # If $CallingFunction is $null
            $CallingFunction = 'NewAzFWPolRCGRule'                                           # Creates $CallingFunction
...
}                                                                                           # End function NewAzFWPolRCGRule    
function ListAzFWPolRCGRule {                                                                # Function to list all firewall policy rule collection group
    Begin {                                                                                 # Begin function
...
}                                                                                           # End function ListAzFWPolRCGRule
function RemoveAzFWPolRCGRule {                                                              # Function to remove a firewall policy rule collection group
    Begin {                                                                                 # Begin function
        if (!$CallingFunction) {                                                            # If $CallingFunction is $null
            $CallingFunction = 'RemoveAzFWPolRCGRule'                                        # Creates $CallingFunction
        }                                                                                   # End if (!$CallingFunction)
        :RemoveAzureFWPolicyRCG while ($true) {                                             # Outer loop for managing function
            $FWPolicyRCGObject, $FWPolicyObject = GetAzFWPolRCGRule ($CallingFunction)       # Calls function and assigns output to $var
...
}                                                                                           # End function RemoveAzFWPolRCGRule
function SetAzFWPolRCGRulePri {                                                              # Function to set a firewall policy rule collection group priority
    Begin {                                                                                 # Begin function
        if (!$CallingFunction) {                                                            # If $CallingFunction is $null
            $CallingFunction = 'SetAzFWPolRCGRulePri'                                        # Creates $CallingFunction
        }                                                                                   # End if (!$CallingFunction)
...
}                                                                                           # End function SetAzFWPolRCGRulePri  
function GetAzFWPolRCGRule {                                                                 # Function to get firewall policy rule collection group
    Begin {                                                                                 # Begin function
...
}                                                                                           # End function GetAzFWPolRCGRule