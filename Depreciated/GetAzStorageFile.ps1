...
<# Process Flow {
    function
        ...
        End GetAzStorageShareFile
            Return function > Send StorageShareFileObject, $StorageShareObject, $StorageAccObject
}#>
    ...
    Begin {                                                                                 # Begin function
        ...
        :SelectAzureShareFolder while ($true) {                                             # Outer loop for managing function
            ...
            :SelectSubFolder while ($true) {                                                # Inner loop for selecting subfolder
                ...
                Write-Host '[3]  Select a folder for action'                                # Write message to screen
                Write-Host '[4]  Select a file for action'                                  # Write message to screen
